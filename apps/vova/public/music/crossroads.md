...
Как писал уже точно не помню. Помню, что были где-то в Нижнем, проездом из
Татарии. Я тогда много накидывал промптов для риффов а-ля "punk metalcore". Этот
заполнился, видимо, больше других. Сразу что-то представилось такое одновременно
и неизвестное, и в даль зовущее -- в дороге такое частенько случается.

Начинал писать, кажется, намного раньше 2024-12, но не устраивала концовка и
какие-то _слишком_ ИИшные слова (тогда для меня писать тексты с чатгпт было ещё
вновинку, он лишь недавно научился рифмовать, поэтому, каюсь, немного
злоупотреблял).
...
Крутани циферблат судьбы
Ждать некогда

Перекрёсток говорит так ясно
