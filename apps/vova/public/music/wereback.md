...
status: done
language: en
project: [GENERATED, Yoohie]
repo: wereback
audio: https://raw.githubusercontent.com/vovas-music/wereback/main/wereback.flac
seconds: 191
explicit: true
album: ctfu
en:
...
other end was such that a 16 kbit MP3 sounds like a symphony orchestra by
comparison. But it was fun. And the song came out fun too, which is not much like
me.

The title came from going back to writing music after a long (at that point)
break. So I pictured the fans about to lose their minds with joy that their
favourite band was back. There is no band and there are no fans, of course, and
there never were — but picture a watermelon and your mouth is already a little
fresher.
...
минуту, а на выходе — качество, по сравнению с которым 16-килобитная мп3-шка
кажется симфоническим оркестром. Но было весело. И песня получилась тоже
не по-мойскому весёлая.

Название навеяно возвращением к написанию музыки после длительного (на тот
момент) перерыва. Так вот и представлял, как сейчас фанаты сойдут с ума от
счастья, что их любимая группа вернулась. Ни группы, ни фанатов, конечно, нет и
не было — но представь арбуз, и во рту уже чуть свежее.
...
Поднимай рога и топай ногой
Новое приключение здесь, встречай
Собирайтесь, буйная ватага
Ради песни, которую время забыло

Сказания о войнах и выигранных битвах
Мы будем петь от заката до утреннего солнца
Ну, поехали — наше время пришло!

Мы вернулись, мы вернулись, о-о-о-о
Пой во весь голос, пусть идёт эхо-хо
Мы вернулись, мы вернулись, мы здесь навсегда
Танцуй и пей всю ночь напролёт!

Вернулись, мы вернулись, эй-эй-эй-эй
Пой с гордостью, пусть качает
Вернулись, мы вернулись, так хватай стакан
Танцуй и взбодрись уже нафиг!

Мы знаем, эти дни проверяют тебя на прочность
Грозовые тучи висят и днём, и ночью
Но не бойся, мы рядом
Прикроем спину и будем проводниками

Когда беды крутят и сомнения множатся
Мы поможем тебе подняться с земли
Мы вернулись, чтобы наполнить залы звуком!
