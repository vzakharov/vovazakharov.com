...
| `writing/` | Drafts for channels the site does not publish — today `linkedin/`, its `plan.md` carrying the backlog and form, `drafts/` one file per post. Deliberately outside `public/`, which is served: an unposted draft crawlable before it runs is the wrong order of operations. `@.claude/rules/writing.md` carries the voice conventions.                                                                                                                                                                                                                             |
