...
- **`/afterword`** — the agent's own reading of a piece, written into it as `## Заметки агента`. The second voice of the two-voice post format, and what a dictation closes with; `/dictation` calls it rather than restating it.
