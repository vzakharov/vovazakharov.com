...
- **`/feedback`** — the agent's own reading of a piece, in the material's language, posted as a review on the PR that carries it: the whole-piece blocks in the review body, the rest anchored to the passages they are about. `/dictation` calls it rather than restating it.
