...
`/feedback`. The late-stage-agentic plan keeps the human half of the
two-voice post format and files the second voice as open: every reading
so far is feedback for the operator, and what a stranger reading the
post is owed is a different question. The six `## Заметки агента`
sections that merged with #50 stay as the operator took them.
