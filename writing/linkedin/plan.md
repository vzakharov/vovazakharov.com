...
| **Regenerated by** | `pnpm content:pdf:vova`                  |
...
| 11    | What parallelism actually measures as                  | The one honest answer to "how much faster did twenty cloud agents make me": 6.8 → 11.2 units of work a day across the switch into the cloud, +65%, at the same median size of about 380 changed lines either side. Two deflating halves, and the post needs both — 65% is not the order of magnitude this gets sold at, and the first published pair of windows was drawn wrong, so the number moved once somebody checked it.                                                                                                                                                           | Measurement |
