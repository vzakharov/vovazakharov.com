...
начинаю. Может быть, это что-то, к чему я приду. А может, и не нужно ни к чему приходить,
...
| -------------------------------------------------------- | ---------------------------------------------- | -------------------------- |
| «со своим кодом сейчас когда кожу»                       | «со своим Клодом сейчас когда кожу»            | не расслышано, прочитал ты |
| «здесь сильная речь, что, как иногда пишут»              | «здесь не идёт речь о том, о чём иногда пишут» | не расслышано              |
| «может объять за свою жизнь только опыта»                | «только so much опыта»                         | не расслышано, прочитал ты |
...
| «потом ты смотришь на кофе»                              | «на код»                                       | не расслышано, прочитал ты |
| «последствия, которые мы за свою жизнь учим»             | «несём»                                        | оговорка в записи          |
| «заработались и встали»                                  | «устали»                                       | оговорка в записи          |
| «находится ответ о том, почему»                          | «ответ на то, почему»                          | оговорка в записи          |
| «ещё одно из моих ограничений»                           | «ещё одна из моих ограниченностей»             | оговорка в записи          |
...
- **В цепочке пропущено звено.** Ты показываешь, что человек ограничен и что из
  ...
  ступень, минуя все остальные. Агент устроен так же — результат мотивации без
  лестницы под ним, а лестница и есть то, чем платят.
