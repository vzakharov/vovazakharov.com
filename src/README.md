...
something earns them. Each site's `apps/<site>/app/` is a Next.js App
Router and nothing else — `layout.tsx` and each `page.tsx` are one-line
re-exports of what they render.
