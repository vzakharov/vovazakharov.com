...
import { Section, Subheading, SUBHEADING_GAP, SummaryCard } from '@/shared/ui';
    ...
    <Section id="writing" standalone>
      ...
      <SimpleGrid cols={{ base: 1, md: 2 }} spacing={16}>
        <SummaryCard
          ...
          href="https://glitchporn.substack.com/p/hard-times-strong-men"
        />
        ...
        <SummaryCard
          ...
          href="https://glitchporn.substack.com/p/the-illusion-of-thinking-different"
        />
        ...
        <SummaryCard
          ...
          href="https://glitchporn.substack.com/p/post-vacation-slump-survival-guide"
        />
      </SimpleGrid>
