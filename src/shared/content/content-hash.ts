 ...
 * authoring script and the build compute it — changing it invalidates every
 * committed render.
 *
 * Deliberately free of `import 'server-only'`, unlike the rest of
 * `shared/content/`: the render scripts run it under bare Node, outside any
 * bundler.
 */
